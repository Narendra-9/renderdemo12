...
class User(db.Model, UserMixin):
    ...
    def password(self,plain_text_password):
        self.hashpassword=bcrypt.generate_password_hash(plain_text_password).decode('utf-8')

    def check_password_correction(self,attempted_password):
        return bcrypt.check_password_hash(self.hashpassword,attempted_password)
